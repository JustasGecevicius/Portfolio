...
export default function About() {
        ...
        {inView && (
          ...
          >
            ...
            <div className="mt-4 text-justify max-w-prose md:text-lg">
              ...
              professionals I have managed to progress swiftly and understand the market standards
              for writing <span className="italic text-blue">Clean and Professional code</span>.{" "}
              <br /> <br />I got hooked on coding from the moment I picked up an Arduino kit. The
              fact that the code I wrote made real world changes seemed fascinating to me. This is
              the reasson why I got drawn to Front-end development as well. The changes made to the
              code appeared on the screen instantly and provided instant feedback. This
              ...
              <br /> <br />
              For all of my skills click <span className="italic text-blue">Resume</span> and for
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen p-5" ref={refference}>
      <Animation />
    </div>
  );
}
